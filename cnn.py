...
class CNN:
    ...
    def test_CNN(self, model_name):
        ...
        cm = confusion_matrix(y_true=self._test_batches.classes, y_pred=np.argmax(predictions, axis=-1), normalize='true', labels=["inside", "inside_vehicle", "office", "outside", "semi_outside"])
